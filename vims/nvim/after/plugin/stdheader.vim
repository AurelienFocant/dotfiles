...
"    Updated: 2025/02/03 12:50:31 by afocant          ###   ########.fr        "
"                                                                              "
" **************************************************************************** "
...
function! s:line(n)
	...
	elseif a:n == 5 " co-author
		return s:textline("By: " . "slangero" . " <" . "slangero@student.s19.be" . ">", s:ascii(a:n))
	elseif a:n == 6 " author
...
command! MyStdheader call s:stdheader ()
map <F2> :MyStdheader<CR>
